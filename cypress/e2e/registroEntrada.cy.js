...
describe('Fluxo Completo e Detalhado do Registro de Entrada', () => {
    ...
    beforeEach(() => {
        cy.session('usuarioLogado', () => {
            ...
            // SOLUÇÃO: Espera por um elemento único da página de login antes de interagir.
            // O texto "Entrar na sua conta" é um bom candidato.
            ...
            cy.get('input[name="email"]').type('guilherme.cruz');
