...
class UpdateColaboradorRequest extends FormRequest
{
    ...
    {
        $colaboradorId = $this->route('colaboradore'); // Laravel usa o nome da rota
        
        return [
            'nome' => 'nullable|string|max:255',
            'cpf' => 'nullable|string|max:14|unique:colaboradores,cpf,' . $colaboradorId,
            'email' => 'nullable|email|max:255|unique:colaboradores,email,' . $colaboradorId,
